...
export let ModalCenter = angular.module('magic.tools.modal.center', [])

.directive('magicModalCenter', function($parse, tools, MAGIC_CONFIG){
...
export default ModalCenter.name;
