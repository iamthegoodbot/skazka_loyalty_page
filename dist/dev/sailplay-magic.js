...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sailplay5 = __webpack_require__(95);

	var _sailplay6 = _interopRequireDefault(_sailplay5);

	var _sailplay7 = __webpack_require__(96);
	  ...
	  return {
	    ...
	    restrict: 'A', scope: false, link: function link(scope, elm, attrs) {
	      ...
	      scope.$watch(function () {
	        ...
	        SailPlay.send('tags.exist', { tags: [MAGIC_CONFIG.data.tag_type] }, function (res) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(19)(IteratorPrototype, __webpack_require__(75)('iterator'), function(){ return this; });
	...
	var USE_NATIVE = !!function(){
	  try {
	    ...
	    var promise     = $Promise.resolve(1)
	      , FakePromise = (promise.constructor = {})[__webpack_require__(75)('species')] = function(exec){ exec(empty, empty); };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _angularSelectbox = __webpack_require__(129);

	var _angularSelectbox2 = _interopRequireDefault(_angularSelectbox);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var Tools = exports.Tools = _angular2.default.module('magic.tools', [_angularUtilsPagination2.default, _angularUiMask2.default, _layout2.default, _widget2.default, _notifier2.default, _modal2.default, _datepicker2.default, _angularSelectbox2.default]).filter('tools', function (MAGIC_CONFIG, $parse) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function selectbox() {
	  ...
	  function SelectboxController($scope, $element, $document, $timeout, Selectbox) {
	    ...
	    function change(value) {
	      ...
	      if (_angular2.default.isDefined(vm.onChange)) {
	...
	function selectboxMulti() {
	  ...
	  SelectboxMultiController.$inject = ["$scope", "$element", "$document", "$timeout", "Selectbox"];
	  return {
	    restrict: 'E',
	...
	function Selectbox() {
	  ...
	  function getDefaults() {
	    ...
	    return _angular2.default.copy(_defaults);
	  }
	...
	exports.default = SelectBox.name;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/less-loader/index.js!./angular-selectbox.less", function() {
				var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/less-loader/index.js!./angular-selectbox.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
