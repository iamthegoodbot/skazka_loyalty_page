...
/***/ (function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(9), __webpack_require__(10), __webpack_require__(11), __webpack_require__(13), __webpack_require__(64), __webpack_require__(19), __webpack_require__(21), __webpack_require__(23), __webpack_require__(53), __webpack_require__(54)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	  } else if (typeof exports !== "undefined") {
	    factory(exports, require("sailplay-hub"), require("sailplay-hub-actions/sailplay.hub.actions"), require("angular"), require("./sailplay/sailplay"), require("./core/core"), require("angular-cookie"), require("angular-touch"), require("./tools/tools"), require("@core/widget"), require("./theme/theme.less"));
	  } else {
	    var mod = {
	      exports: {}
	    };
	    factory(mod.exports, global.sailplayHub, global.sailplayHub, global.angular, global.sailplay, global.core, global.angularCookie, global.angularTouch, global.tools, global.widget, global.theme);
	    global.magic = mod.exports;
	  }
	})(this, function (_exports, _sailplayHub, _sailplayHub2, _angular, _sailplay, _core, _angularCookie, _angularTouch, _tools, _widget, _theme) {
	  "use strict";

	  Object.defineProperty(_exports, "__esModule", {
	    value: true
	  });
	  _exports.default = _exports.magic = void 0;
	  _sailplayHub = _interopRequireDefault(_sailplayHub);
	  _angular = _interopRequireDefault(_angular);
	  _sailplay = _interopRequireDefault(_sailplay);
	  _core = _interopRequireWildcard(_core);
	  _angularCookie = _interopRequireDefault(_angularCookie);
	  _angularTouch = _interopRequireDefault(_angularTouch);
	  ...
	  var magic = _angular.default.module('magic', [_sailplay.default, _core.default, _angularCookie.default, _tools.default, _angularTouch.default]).config(function (SailPlayProvider, MAGIC_CONFIG, SailPlayHistoryProvider, SailPlayActionsDataProvider) {
	  ...
	  function () {
	    function Magic(config) {
	      ...
	      _sailplayHub.default.send('init', config);

	      _sailplayHub.default.on('init.success', function (res) {
	        if (_this.inited) return;

	        _sailplayHub.default.send('magic.config', config.config);
	      });

	      _sailplayHub.default.on('magic.config.success', function (res_config) {
	        ...
	        app_container && _angular.default.bootstrap(app_container, [magic.name]);
	        _this.inited = true;
	      });

	      _sailplayHub.default.on('magic.config.error', function () {
	        alert("Cannot load config with name: ".concat(config.config));
	      }); //public reference to main angular module


	      this.module = magic; //store inited property for disable reinit
	  ...
	  _exports.default = Magic;

	  _defineProperty(Magic, "Widget", _widget.WidgetRegister);

	  _defineProperty(Magic, "version", '${MAGIC_VERSION}');

	  _sailplayHub.default.Magic = _sailplayHub.default.Magic || Magic;
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(11), __webpack_require__(14), __webpack_require__(15), __webpack_require__(16), __webpack_require__(17), __webpack_require__(18), __webpack_require__(19)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	  } else if (typeof exports !== "undefined") {
	    factory(exports, require("angular"), require("./sailplay.profile"), require("./sailplay.gifts"), require("./sailplay.history"), require("./sailplay.actions"), require("./sailplay.badges"), require("angular-cookie"));
	  } else {
	    var mod = {
	      exports: {}
	    };
	    factory(mod.exports, global.angular, global.sailplay, global.sailplay, global.sailplay, global.sailplay, global.sailplay, global.angularCookie);
	    global.sailplay = mod.exports;
	  }
	})(this, function (_exports, _angular, _sailplay, _sailplay2, _sailplay3, _sailplay4, _sailplay5, _angularCookie) {
	  "use strict";

	  Object.defineProperty(_exports, "__esModule", {
	    value: true
	  });
	  _exports.default = _exports.SailPlay = void 0;
	  _angular = _interopRequireDefault(_angular);
	  _sailplay = _interopRequireDefault(_sailplay);
	  _sailplay2 = _interopRequireDefault(_sailplay2);
	  _sailplay3 = _interopRequireDefault(_sailplay3);
	  _sailplay4 = _interopRequireDefault(_sailplay4);
	  _sailplay5 = _interopRequireDefault(_sailplay5);
	  _angularCookie = _interopRequireDefault(_angularCookie);

	  function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	  var SailPlay = _angular.default.module('sailplay', [_sailplay.default, _sailplay2.default, _sailplay3.default, _sailplay4.default, _sailplay5.default, _angularCookie.default]).run(function (SailPlay, $rootScope) {
	    ...
	    return {
	      ...
	      set_remote_config: function set_remote_config(new_config) {
	        _angular.default.merge(auth_options, new_config);
	      },
	          ...
	          switch (type) {
	            case 'url':
	              ...
	              if (params) {
	                ...
	                $rootScope.$broadcast('sailplay-login-error', {
	                  status: 'error',
	                  message: 'No auth_hash found'
	                });
	              }
	    ...
	    _angular.default.forEach(points, function (point) {
	      SailPlay.on(point + '.success', function (res) {
	        ...
	        console.log('sailplay.api:' + point + '.success'); //console.log(JSON.stringify(self.data(point)()));
	      });
	    ...
	    self.data = function (key, value) {
	      if (typeof value !== 'undefined') {
	        data[key] = _angular.default.copy(value);
	      }
	    ...
	    return {
	      ...
	      link: function link(scope, elm, attrs) {
	        ...
	        _angular.default.merge(options, opts);
	  ...
	  _exports.SailPlay = SailPlay;
	  var _default = SailPlay.name;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	  if (true) {
	    ...
	    global.sailplayProfile = mod.exports;
	  }
	})(this, function (_exports, _angular) {
	  "use strict";

	  Object.defineProperty(_exports, "__esModule", {
	    value: true
	  });
	  _exports.default = _exports.SailPlayProfile = void 0;
	  _angular = _interopRequireDefault(_angular);

	  function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	  var SailPlayProfile = _angular.default.module('sailplay.profile', [])
	  /**
	   * @ngdoc directive
	      ...
	      link: function link(scope) {
	        ...
	        scope.tags_add = function (params, callback) {
	          ...
	          if (tags.length > 0) {
	            ...
	            _angular.default.forEach(chunked_tags, function (chunk) {
	              var promise = $q(function (resolve, reject) {
	                SailPlay.send('tags.add', {
	                  tags: chunk
	                }, function (tags_res) {
	                  if (tags_res.status === 'ok') {
	                    resolve(tags_res); //sp.send('leads.submit.success', { lead: self, response: user_res, tags: res });
	                  } else {
	                    reject(tags_res); //sp.send('leads.submit.error', { lead: self, response: user_res, tags: res });
	                  }
	                });
	              });
	      ...
	      link: function link(scope, elm, attrs) {
	        ...
	        SailPlayApi.observe('load.user.info', function (user) {
	          ...
	          form.fields = config.fields.map(function (field) {
	            ...
	            if (field.type == 'variable') custom_fields.push(form_field); //we need to assign received values to form
	          ...
	          form.auth_hash = SailPlay.config().auth_hash; //angular.extend(scope.profile_form.user, user.user);
	          ...
	          console.dir(form);
	          saved_form = _angular.default.copy(form);
	          ...
	          if (custom_fields.length) {
	            SailPlayApi.call("vars.batch", {
	              ...
	              _angular.default.forEach(res.vars, function (variable) {
	                _angular.default.forEach(custom_fields, function (field) {
	        ...
	        scope.revert_profile_form = function (form) {
	          ...
	          scope.sailplay.fill_profile.form = _angular.default.copy(saved_form);
	        };
	        ...
	        scope.sailplay.fill_profile.submit = function (form, callback) {
	          ...
	          _angular.default.forEach(scope.sailplay.fill_profile.form.fields, function (item) {
	          ...
	          if (req_user.birthDate) {
	            var bd = _angular.default.copy(req_user.birthDate);
	  ...
	  _exports.SailPlayProfile = SailPlayProfile;
	  var _default = SailPlayProfile.name;
	  _exports.default = _default;
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	  if (true) {
	    ...
	    factory(mod.exports, global.angular);
	    global.sailplayGifts = mod.exports;
	  }
	})(this, function (_exports, _angular) {
	  "use strict";
	  ...
	  _exports.default = _exports.SailPlayGifts = void 0;
	  _angular = _interopRequireDefault(_angular);

	  function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	  var SailPlayGifts = _angular.default.module('sailplay.gifts', [])
	  /**
	   * @ngdoc directive
	    ...
	    return {
	      ...
	      link: function link(scope) {
	        ...
	        SailPlayApi.observe('load.gifts.list', function (result) {
	          build_progress(result, user()).then(function () {
	            if (scope.$root.$$phase != '$digest') scope.$digest();
	          });
	        });
	  ...
	  _exports.SailPlayGifts = SailPlayGifts;
	  var _default = SailPlayGifts.name;
	  _exports.default = _default;
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	  if (true) {
	    ...
	    factory(mod.exports, global.angular);
	    global.sailplayHistory = mod.exports;
	  }
	})(this, function (_exports, _angular) {
	  "use strict";
	  ...
	  _exports.default = _exports.SailPlayHistory = void 0;
	  _angular = _interopRequireDefault(_angular);

	  function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	  var SailPlayHistory = _angular.default.module('sailplay.history', [])
	  /**
	   * @ngdoc directive
	  ...
	  .directive('sailplayHistory', function (SailPlayApi) {
	    ...
	    return {
	      set_dictionary: function set_dictionary(new_dict) {
	        _angular.default.merge(dict, new_dict);
	      },
	      $get: function $get() {
	        return {
	          dict: dict
	  ...
	  _exports.SailPlayHistory = SailPlayHistory;
	  var _default = SailPlayHistory.name;
	  _exports.default = _default;
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	  if (true) {
	    ...
	    factory(mod.exports, global.angular);
	    global.sailplayActions = mod.exports;
	  }
	})(this, function (_exports, _angular) {
	  "use strict";
	  ...
	  _exports.default = _exports.SailPlayActions = void 0;
	  _angular = _interopRequireDefault(_angular);

	  function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	  var SailPlayActions = _angular.default.module('sailplay.actions', []).provider('SailPlayActionsData', function () {
	    var actions_data = {
	      "system": {
	        "emailBinding": {
	          name: "Enter email"
	    ...
	    return {
	      set_actions_data: function set_actions_data(data) {
	        _angular.default.merge(actions_data, data);
	      },
	      $get: function $get() {
	        return actions_data;
	      }
	    ...
	    self.addTags = function (data, callback) {
	      var _send_data = _angular.default.copy(data);
	      ...
	      function sending(tags) {
	        SailPlayApi.call('tags.add', {
	          ...
	          if (Object.keys(_send_data.vars).length) {
	            SailPlayApi.call('vars.add', {
	              custom_vars: _send_data.vars
	            }, function () {
	              callback && callback();
	            });
	          } else {
	    ...
	    return {
	      ...
	      link: function link(scope, elm, attrs) {
	        ...
	        function parse_action(action) {
	          $timeout(function () {
	            attrs.styles && elm.attr('data-styles', attrs.styles); // console.log(attrs.styles);
	  ...
	  _exports.SailPlayActions = SailPlayActions;
	  var _default = SailPlayActions.name;
	  _exports.default = _default;
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	  if (true) {
	    ...
	    factory(mod.exports, global.angular);
	    global.sailplayBadges = mod.exports;
	  }
	})(this, function (_exports, _angular) {
	  "use strict";
	  ...
	  _exports.default = _exports.SailPlayBadges = void 0;
	  _angular = _interopRequireDefault(_angular);

	  function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	  var SailPlayBadges = _angular.default.module('sailplay.badges', []).provider('SailPlayBadges', function () {
	    var limits = [];
	    return {
	  ...
	  .directive('sailplayBadges', function (SailPlayApi, SailPlayBadges) {
	    return {
	      ...
	      link: function link(scope) {
	        ...
	        scope.sailplay = scope.sailplay || {}; //ok then we need define badges functionality
	  ...
	  _exports.SailPlayBadges = SailPlayBadges;
	  var _default = SailPlayBadges.name;
	  _exports.default = _default;
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(11), __webpack_require__(24), __webpack_require__(26), __webpack_require__(28), __webpack_require__(49), __webpack_require__(34), __webpack_require__(38), __webpack_require__(43), __webpack_require__(47)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	  } else if (typeof exports !== "undefined") {
	    factory(exports, require("angular"), require("angular-utils-pagination"), require("angular-ui-mask"), require("./layout/layout"), require("./widget/widget"), require("./notifier/notifier"), require("./modal/modal"), require("./fonts/fonts"), require("./datepicker/datepicker"));
	  } else {
	    var mod = {
	      exports: {}
	    };
	    factory(mod.exports, global.angular, global.angularUtilsPagination, global.angularUiMask, global.layout, global.widget, global.notifier, global.modal, global.fonts, global.datepicker);
	    global.tools = mod.exports;
	  }
	})(this, function (_exports, _angular, _angularUtilsPagination, _angularUiMask, _layout, _widget, _notifier, _modal, _fonts, _datepicker) {
	  "use strict";

	  Object.defineProperty(_exports, "__esModule", {
	    value: true
	  });
	  _exports.default = _exports.Tools = void 0;
	  _angular = _interopRequireDefault(_angular);
	  _angularUtilsPagination = _interopRequireDefault(_angularUtilsPagination);
	  _angularUiMask = _interopRequireDefault(_angularUiMask);
	  _layout = _interopRequireDefault(_layout);
	  _widget = _interopRequireDefault(_widget);
	  _notifier = _interopRequireDefault(_notifier);
	  ...
	  var Tools = _angular.default.module('magic.tools', [_angularUtilsPagination.default, _angularUiMask.default, _fonts.default, _layout.default, _widget.default, _notifier.default, _modal.default, _datepicker.default]).filter('tools', function (MAGIC_CONFIG, $parse) {
	    return function (key) {
	  ...
	  .directive('dateSelector', function () {
	    return {
	      ...
	      link: function link(scope, elm, attrs, ngModelCtrl) {
	        ...
	        ngModelCtrl.$formatters.push(function (modelValue) {
	          return modelValue ? _angular.default.copy(modelValue).split('-').reverse() : ['', '', ''];
	        });

	        ngModelCtrl.$render = function () {
	          scope.selected_date = _angular.default.copy(ngModelCtrl.$viewValue);
	        };

	        ngModelCtrl.$parsers.push(function (viewValue) {
	          return viewValue && _angular.default.copy(viewValue).reverse().join('-');
	        });

	        ngModelCtrl.$validators.required = function (modelValue, viewValue) {
	          var valid = true;

	          _angular.default.forEach(viewValue, function (val) {
	        ...
	        scope.$watchCollection('selected_date', function () {
	          ngModelCtrl.$setViewValue(_angular.default.copy(scope.selected_date));
	        });
	      }
	    };
	    ...
	    return {
	      ...
	      link: function link(scope, elm, attrs) {
	        ...
	        scope.show_right = true; // Переделать
	        ...
	        scope.set_position = function (position) {
	          ...
	          _angular.default.forEach(slides, function (slide) {
	            slide.style.width = '';
	          });
	    ...
	    return {
	      ...
	      link: function link(scope, element, attrs) {
	        function append_styles() {
	          ...
	          _angular.default.forEach(tools_config, function (tool) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	  if (true) {
	    ...
	    factory(exports, require("angular"), require("./layout.html"), require("./layout.less"));
	  } else {
	    var mod = {
	      exports: {}
	    };
	    factory(mod.exports, global.angular, global.layout, global.layout);
	    global.layout = mod.exports;
	  }
	})(this, function (_exports, _angular, _layout, _layout2) {
	  "use strict";

	  Object.defineProperty(_exports, "__esModule", {
	    value: true
	  });
	  _exports.default = _exports.Layout = void 0;
	  _angular = _interopRequireDefault(_angular);
	  _layout = _interopRequireDefault(_layout);

	  function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	  var Layout = _angular.default.module('magic.tools.layout', []).directive('layout', function () {
	    return {
	      restrict: 'E',
	      replace: true,
	      scope: {
	      ...
	      template: _layout.default,
	      link: function link(scope, elm, attrs) {}
	    };
	  });

	  _exports.Layout = Layout;
	  var _default = Layout.name;
	  _exports.default = _default;
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(11), __webpack_require__(35), __webpack_require__(36)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	  } else if (typeof exports !== "undefined") {
	    factory(exports, require("angular"), require("./notifier.html"), require("./notifier.less"));
	  } else {
	    var mod = {
	      exports: {}
	    };
	    factory(mod.exports, global.angular, global.notifier, global.notifier);
	    global.notifier = mod.exports;
	  }
	})(this, function (_exports, _angular, _notifier, _notifier2) {
	  "use strict";

	  Object.defineProperty(_exports, "__esModule", {
	    value: true
	  });
	  _exports.default = _exports.Notifier = void 0;
	  _angular = _interopRequireDefault(_angular);
	  _notifier = _interopRequireDefault(_notifier);

	  function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	  var Notifier = _angular.default.module('magic.tools.notifier', []).directive('notifier', function (MAGIC_CONFIG) {
	    return {
	      restrict: 'E',
	      replace: true,
	      scope: true,
	      template: _notifier.default,
	      link: function link(scope) {
	        ...
	        scope.reset_notifier = function () {
	          scope.data = _angular.default.copy(new_data);
	  ...
	  _exports.Notifier = Notifier;
	  var _default = Notifier.name;
	  _exports.default = _default;
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(11), __webpack_require__(39), __webpack_require__(40), __webpack_require__(42)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	  } else if (typeof exports !== "undefined") {
	    factory(exports, require("angular"), require("./modal.html"), require("./modal.less"), require("./close.png"));
	  } else {
	    var mod = {
	      exports: {}
	    };
	    factory(mod.exports, global.angular, global.modal, global.modal, global.close);
	    global.modal = mod.exports;
	  }
	})(this, function (_exports, _angular, _modal, _modal2, _close) {
	  "use strict";

	  Object.defineProperty(_exports, "__esModule", {
	    value: true
	  });
	  _exports.default = _exports.Modal = void 0;
	  _angular = _interopRequireDefault(_angular);
	  _modal = _interopRequireDefault(_modal);
	  ...
	  var Modal = _angular.default.module('magic.tools.modal', []).directive('magicModal', function ($parse, tools, MAGIC_CONFIG) {
	    return {
	      restrict: 'E',
	      replace: true,
	      template: _modal.default,
	      scope: {
	        config: '=?'
	      },
	      transclude: true,
	      link: function link(scope, elm, attrs) {
	        ...
	        scope.show = false;
	        scope.close_image = _close.default;
	        ...
	        scope.$watch(function () {
	          return _angular.default.toJson([scope.$parent.$eval(attrs.show)]);
	        }, function () {
...
/***/ (function(module, exports) {
	...
	module.exports = "data:image/png;base64,"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	  if (true) {
	    ...
	    factory(exports, require("angular"), require("./fonts.html"), require("./fonts.less"));
	  } else {
	    var mod = {
	      exports: {}
	    };
	    factory(mod.exports, global.angular, global.fonts, global.fonts);
	    global.fonts = mod.exports;
	  }
	})(this, function (_exports, _angular, _fonts, _fonts2) {
	  "use strict";

	  Object.defineProperty(_exports, "__esModule", {
	    value: true
	  });
	  _exports.default = _exports.Fonts = void 0;
	  _angular = _interopRequireDefault(_angular);
	  _fonts = _interopRequireDefault(_fonts);

	  function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	  var Fonts = _angular.default.module('magic.tools.fonts', []).directive('fonts', function () {
	    return {
	      restrict: 'E',
	      replace: true,
	      scope: false,
	      template: _fonts.default
	    };
	  });

	  _exports.Fonts = Fonts;
	  var _default = Fonts.name;
	  _exports.default = _default;
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".spm_wrapper .spm_tools_fonts {\n  display: none;\n}\n", ""]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	  if (true) {
	    ...
	    factory(exports, require("angular"), require("./datepicker.html"));
	  } else {
	    var mod = {
	      exports: {}
	    };
	    factory(mod.exports, global.angular, global.datepicker);
	    global.datepicker = mod.exports;
	  }
	})(this, function (_exports, _angular, _datepicker) {
	  "use strict";

	  Object.defineProperty(_exports, "__esModule", {
	    value: true
	  });
	  _exports.default = _exports.ToolsDatepicker = void 0;
	  _angular = _interopRequireDefault(_angular);
	  _datepicker = _interopRequireDefault(_datepicker);

	  function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	  var ToolsDatepicker = _angular.default.module('ui.datepicker', []).service('dateService', function () {
	    var self = this;
	    self.days = {
	      1: 31,
	      2: 29,
	  ...
	  _exports.ToolsDatepicker = ToolsDatepicker;
	  var _default = ToolsDatepicker.name;
	  _exports.default = _default;
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(11), __webpack_require__(50), __webpack_require__(51)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	  } else if (typeof exports !== "undefined") {
	    factory(exports, require("angular"), require("./widget.html"), require("./widget.less"));
	  } else {
	    var mod = {
	      exports: {}
	    };
	    factory(mod.exports, global.angular, global.widget, global.widget);
	    global.widget = mod.exports;
	  }
	})(this, function (_exports, _angular, _widget, _widget2) {
	  "use strict";

	  Object.defineProperty(_exports, "__esModule", {
	    value: true
	  });
	  _exports.default = _exports.Widget = void 0;
	  _angular = _interopRequireDefault(_angular);
	  _widget = _interopRequireDefault(_widget);

	  function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	  var Widget = _angular.default.module('magic.tools.widget', []).directive('widget', function ($compile, MagicWidget, $injector) {
	    return {
	      restrict: 'E',
	      replace: true,
	      scope: {
	      ...
	      template: _widget.default,
	      link: function link(scope, elm, attrs) {
	        var widget_wrapper = _angular.default.element(elm[0].querySelector('[data-widget-wrapper]'));
	        ...
	        scope.$watch('widget', function (widget) {
	          ...
	          if (!WIDGET_CONFIG) {
	            throw "Widget with id: ".concat(widget.id, " not registered!");
	          }
...
/***/ (function(module, exports) {
	...
	module.exports = "<div class=\"spm_tools_widget {{ widget.id }}\" data-ng-show=\"widget.enabled\" data-ng-hide=\"widget.options.hiddenAnonymous && !widget.user()\">\n  <widget-style data-widget=\"widget\"></widget-style>\n  <div data-widget-wrapper class=\"clearfix\"></div>\n</div>";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	  ...
	  _exports.WidgetRegister = WidgetRegister;
	  _exports.default = _exports.Widget = void 0;
	  _angular = _interopRequireDefault(_angular);

	  function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	  var Widget = _angular.default.module('magic.widget', []).provider('MagicWidget', function () {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(11), __webpack_require__(13), __webpack_require__(53)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	  } else if (typeof exports !== "undefined") {
	    factory(exports, require("angular"), require("../sailplay/sailplay"), require("./widget"));
	  } else {
	    var mod = {
	      exports: {}
	    };
	    factory(mod.exports, global.angular, global.sailplay, global.widget);
	    global.core = mod.exports;
	  }
	})(this, function (_exports, _angular, _sailplay, _widget) {
	  "use strict";

	  Object.defineProperty(_exports, "__esModule", {
	    value: true
	  });
	  _exports.default = _exports.Core = void 0;
	  _angular = _interopRequireDefault(_angular);
	  _sailplay = _interopRequireDefault(_sailplay);
	  _widget = _interopRequireDefault(_widget);
	  ...
	  var Core = _angular.default.module('magic.core', [_sailplay.default, _widget.default]).run(function (SailPlay, SailPlayApi, $rootScope, $window, MAGIC_CONFIG, $timeout, QuizService) {
	    //we need global template reference for config
	    $rootScope.MAGIC_CONFIG = MAGIC_CONFIG; //reset to unauthorized state
	    ...
	    var TAGS = QuizService.getTags(); //wait for sailplay inited, then try to login by cookie (we need to see unauthorized content)

	    SailPlay.authorize('cookie'); //we need to save auth hash in cookies for authorize status tracking
