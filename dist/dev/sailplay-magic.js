...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _angularCookie = __webpack_require__(61);

	var _angularCookie2 = _interopRequireDefault(_angularCookie);

	var _angularTouch = __webpack_require__(65);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _sailplay5 = __webpack_require__(58);

	var _sailplay6 = _interopRequireDefault(_sailplay5);

	var _sailplay7 = __webpack_require__(59);

	var _sailplay8 = _interopRequireDefault(_sailplay7);

	var _sailplay9 = __webpack_require__(60);
	  ...
	  return {
	    ...
	    restrict: 'A', scope: false, link: function link(scope, elm, attrs) {
	      ...
	      function build_user(user) {
	        ...
	        if (scope.$root.$$phase != '$digest' && scope.$root.$$phase != '$apply') scope.$digest();
	      }
	      ...
	      scope.sailplay.fill_profile.focus = function (event, field) {
	        ...
	        var input;
	        setTimeout(function () {
	          input = _angular2.default.element(par.querySelector("input"));
	          if (input.length) {
	            input[0].focus();
	          }
	        }, 50);
	      ...
	      scope.sailplay.fill_profile.submit = function (form, callback) {
	        ...
	        var fields = _angular2.default.copy(scope.sailplay.fill_profile.form.fields);

	        _angular2.default.forEach(fields, function (item) {
	        ...
	        if (!(0, _keys2.default)(req_user).length && !(0, _keys2.default)(custom_user_vars).length) {
	      ...
	      _angular2.default.element(document.body).bind('click', clear_edit);
	    }
