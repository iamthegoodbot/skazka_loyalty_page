...
/***/ function(module, exports, __webpack_require__) {
	...
	var _angularCookie = __webpack_require__(95);

	var _angularCookie2 = _interopRequireDefault(_angularCookie);

	var _angularTouch = __webpack_require__(99);

	var _angularTouch2 = _interopRequireDefault(_angularTouch);

	var _tools = __webpack_require__(101);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sailplay3 = __webpack_require__(57);

	var _sailplay4 = _interopRequireDefault(_sailplay3);

	var _sailplay5 = __webpack_require__(92);

	var _sailplay6 = _interopRequireDefault(_sailplay5);

	var _sailplay7 = __webpack_require__(93);

	var _sailplay8 = _interopRequireDefault(_sailplay7);

	var _sailplay9 = __webpack_require__(94);
	  ...
	  return {
	    ...
	    restrict: 'A', scope: false, link: function link(scope, elm, attrs) {
	      ...
	      scope.check_error = function (field) {
	        // its strange bug
	        if (field.has_other && (!field.value || field.value == 'undefined' || field.value == ',') && !field.other) valid = false;else if (!field.has_other && !field.value) valid = false;else valid = true;
	      ...
	      scope.sailplay.fill_profile.submit = function (form, callback) {
	        ...
	        _angular2.default.forEach(scope.sailplay.fill_profile.form.fields, function (item) {
	          ...
	          if (item.input == 'multiple') item.value = item.other && 'other_' + item.other || (0, _stringify2.default)(item.value);
	          ...
	          if (user_res.status === 'ok') {
	            if ((0, _keys2.default)(custom_user_vars).length) {
	              var max_vars = 15,
	                  chunk = {},
	                  i = 0;
	              _angular2.default.forEach((0, _keys2.default)(custom_user_vars), function (key, index) {
	                i++;
	                chunk[key] = custom_user_vars[key];

	                if (i == max_vars || index == (0, _keys2.default)(custom_user_vars).length - 1) {
	                  var chunk_to_api = _angular2.default.copy(chunk);
	                  chunk = {};
	                  i == 0;
	                  SailPlay.send('vars.add', { custom_vars: chunk_to_api }, function (res_vars) {
	  ...
	  return {
	    ...
	    link: function link(scope) {
	      ...
	      (function observeGifts() {
	        _promise2.default.all([SailPlayApi.observe('load.gifts.list'), SailPlayApi.observe('load.user.info')]).then(function (result) {
	          build_progress(result[0], result[1]).then(function () {
	            if (scope.$root.$$phase != '$digest') scope.$digest();
	          });
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(19)(IteratorPrototype, __webpack_require__(72)('iterator'), function(){ return this; });
	...
	var USE_NATIVE = !!function(){
	  try {
	    ...
	    var promise     = $Promise.resolve(1)
	      , FakePromise = (promise.constructor = {})[__webpack_require__(72)('species')] = function(exec){ exec(empty, empty); };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _angularUtilsPagination = __webpack_require__(102);

	var _angularUtilsPagination2 = _interopRequireDefault(_angularUtilsPagination);

	var _angularUiMask = __webpack_require__(104);
	...
	var _widget = __webpack_require__(112);

	var _widget2 = _interopRequireDefault(_widget);

	var _notifier = __webpack_require__(116);
