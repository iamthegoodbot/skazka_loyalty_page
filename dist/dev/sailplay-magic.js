...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _angularCookie = __webpack_require__(93);

	var _angularCookie2 = _interopRequireDefault(_angularCookie);

	var _angularTouch = __webpack_require__(97);

	var _angularTouch2 = _interopRequireDefault(_angularTouch);

	var _tools = __webpack_require__(99);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _sailplay3 = __webpack_require__(89);

	var _sailplay4 = _interopRequireDefault(_sailplay3);

	var _sailplay5 = __webpack_require__(90);

	var _sailplay6 = _interopRequireDefault(_sailplay5);

	var _sailplay7 = __webpack_require__(91);

	var _sailplay8 = _interopRequireDefault(_sailplay7);

	var _sailplay9 = __webpack_require__(92);
	    ...
	    restrict: 'A', scope: false, link: function link(scope, elm, attrs) {
	      ...
	      SailPlayApi.observe('load.user.info', function (user) {
	        ...
	        form.fields = config.fields.map(function (field) {
	          ...
	          if (field.type == 'tags') tag_fields.push(form_field);
	        ...
	        if (tag_fields.length) {
	          ...
	          _angular2.default.forEach(tag_fields.reduce(function (prev, next) {
	            if (!next.data) return prev.concat(next.tag_on);
	            return prev.concat(next.data.reduce(function (_prev, _next) {
	              return _prev.concat(_next.tag_on);
	            }, []));
	          }, []), function (el) {
	            return el && tags_to_test.push(el);
	          });
	          ...
	          for (i = 0, j = tags_to_test.length; i < j; i += chunk) {
	            ...
	            SailPlayApi.call('tags.exist', { tags: temparray }, function (res) {
	              _angular2.default.forEach(res.tags, function (tag) {
	                _angular2.default.forEach(tag_fields, function (tag_field) {
	                  ...
	                  _angular2.default.forEach(tag_field.data, function (tag_field_item, index) {
	        ...
	        _angular2.default.forEach(scope.sailplay.fill_profile.form.fields, function (item) {
	          switch (item.type) {
	            ...
	            case 'tags':
	              ...
	              } else _angular2.default.forEach(item.data, function (i, index) {
	                if (item.input == 'radiolist' && index == item.value || item.input == 'checklist' && item['value_' + index]) {
	          ...
	          if (user_res.status === 'ok') {
	            ...
	            for (i = 0, j = tag_to_applied.length; i < j; i += chunk) {
	              ...
	              promises.push(new _promise2.default(function (resolve) {
	                return SailPlay.send('tags.add', { tags: temparray }, resolve);
	              }));
	            }
	            ...
	            for (i = 0, j = tag_to_unapplied.length; i < j; i += chunk) {
	              ...
	              promises.push(new _promise2.default(function (resolve) {
	                return SailPlay.send('tags.delete', { tags: temparray }, resolve);
	              }));
	            }

	            if ((0, _keys2.default)(custom_user_vars).length) {
	              promises.push(new _promise2.default(function (resolve) {
	                return SailPlay.send('vars.add', { custom_vars: custom_user_vars }, resolve);
	              }));
	            }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__webpack_require__(19)(IteratorPrototype, __webpack_require__(69)('iterator'), function(){ return this; });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _angularUtilsPagination = __webpack_require__(100);

	var _angularUtilsPagination2 = _interopRequireDefault(_angularUtilsPagination);

	var _angularUiMask = __webpack_require__(102);
	...
	var _notifier = __webpack_require__(114);
	...
	var _fonts = __webpack_require__(122);
	...
	var Tools = exports.Tools = _angular2.default.module('magic.tools', [_angularUtilsPagination2.default, _angularUiMask2.default, _fonts2.default, _layout2.default, _widget2.default, _notifier2.default, _modal2.default, _datepicker2.default]).filter('tools', function (MAGIC_CONFIG, $parse) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _notifier = __webpack_require__(115);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Modal = exports.Modal = _angular2.default.module('magic.tools.modal', []).directive('magicModal', function ($parse, tools, MAGIC_CONFIG, $rootScope) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _fonts = __webpack_require__(123);
