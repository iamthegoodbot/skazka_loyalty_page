...
/***/ (function(module, exports, __webpack_require__) {
	...
	_widget.Widget.filter('removePrefix', function () {
	...
	_widget.Widget.filter('onlyEvents', function () {
	  return function (items) {
	    return items && items.filter(function (x) {
	      return x.name.indexOf('[event]') == 0;
	    });
	  };
	});

	_widget.Widget.filter('withoutEvents', function () {
	  return function (items) {
	    return items && items.filter(function (x) {
	      return x.name.indexOf('[event]') != 0;
	    });
	  ...
	  controller: function controller(tools, SailPlayApi, SailPlay) {
	    ...
	    return function (scope, elm, attrs) {
	      ...
	      scope.$watch('action_custom_selected', function (new_val, old_val) {
	        // if user close popup, update actions
	        if (old_val && !new_val) {
...
/***/ (function(module, exports) {
	...
	module.exports = "<div class=\"spm_tabs clearfix\" data-ng-if=\"widget.enabled\">\n\n    <div class=\"spm_tab_list\">\n        <a href=\"#\" class=\"spm_tab_list_item\" data-ng-class=\"{type_active: tab.widget==$parent.active_tab }\"\n           data-ng-repeat=\"tab in widget.options.tabs\"\n           data-ng-bind=\"tab.name\" data-ng-click=\"$event.preventDefault();$parent.active_tab=tab.widget;\"></a>\n    </div>\n\n    <div class=\"spm_tabs_content\">\n        <widget class=\"spm_tabs_content_widget\"\n                data-ng-repeat=\"widget in widget.options.widgets\" data-widget=\"widget\"\n                data-ng-class=\"{type_active: active_tab == widget.id}\"></widget>\n    </div>\n\n</div>";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".spm_wrapper .spm_tabs {\n  width: 100%;\n  margin: 0 auto;\n  box-sizing: border-box;\n  position: relative;\n}\n", ""]);
