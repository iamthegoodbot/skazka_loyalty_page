...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _angular = __webpack_require__(86);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _badges = __webpack_require__(149);

	var _badges2 = _interopRequireDefault(_badges);

	var _badgesBadge = __webpack_require__(150);

	var _badgesBadge2 = _interopRequireDefault(_badgesBadge);

	var _badgesLine = __webpack_require__(151);
...
/***/ (function(module, exports) {
	...
	module.exports = "<div class=\"clearfix\">\n  <div class=\"container\" data-ng-cloak>\n    <a class=\"button_primary widget-button ng-binding\" data-ng-bind=\"widget.text\" ng-href=\"{{ widget.url }}\">Авторизация/регистрация</a>      \n  </div>\n</div>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _cardQuests = __webpack_require__(163);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _charityPro = __webpack_require__(167);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _event_message = __webpack_require__(171);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _gifts = __webpack_require__(175);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _gifts = __webpack_require__(174);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _giftsGrid = __webpack_require__(180);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _hc_profile = __webpack_require__(184);

	var _hc_profile2 = _interopRequireDefault(_hc_profile);

	var _history_pagination = __webpack_require__(185);
	...
	(0, _widget.WidgetRegister)({
	  id: 'hc_profile',
	  template: _hc_profile2.default,
	  inject: ['SailPlayApi', '$timeout'],
	  controller: function controller(SailPlayApi, $timeout) {
	    return function (scope, elm, attrs) {

	      scope.status_list = [];

	      var status_list = angular.copy(scope.widget.options.status).sort(function (a, b) {
	        return a.points - b.points;
	      });

	      var tags = status_list.map(function (status) {
	        return status.tag;
	      });
	        ...
	        SailPlayApi.call('tags.exist', { tags: tags }, function (res) {
	          scope.$apply(function () {
	            if (res && res.tags) {
	              ...
	              scope.status_list = status_list.map(function (status) {
	                var current_status = status;
	                if (res.tags.filter(function (tag) {
	                  return tag.name == current_status.tag && tag.exist;
	                })[0]) {
	      ...
	      scope.getCurrentStatus = function (status_list) {
	        var list = status_list.filter(function (status) {
	      ...
	      scope.getStatus = function (status) {
	        ...
	        SailPlayApi.call('tags.add', { tags: [status.tag] }, function (res) {
	          scope.$apply(function () {
	...
	_widget.Widget.run(["$templateCache", function ($templateCache) {
	  $templateCache.put('hc_profile.history_pagination', _history_pagination2.default);
	}]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/index.js!./hc_profile.less", function() {
				var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/index.js!./hc_profile.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".spm_wrapper .spm_tools_widget.hc_profile .container {\n  position: relative;\n  overflow: visible;\n  max-width: 1100px;\n  width: 100%;\n  margin: 0 auto;\n  -webkit-box-sizing: border-box;\n  -moz-box-sizing: border-box;\n  box-sizing: border-box;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-oid {\n  position: absolute;\n  right: 0;\n  top: -35px;\n  width: 470px;\n  text-align: center;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-left {\n  background: #F8F8F8;\n  float: left;\n  width: 100%;\n  box-sizing: border-box;\n  padding: 30px;\n  max-width: 800px;\n  border-top-left-radius: 15px;\n  text-align: center;\n  min-height: 327px;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-left-pic {\n  text-align: center;\n  width: 30%;\n  box-sizing: border-box;\n  padding-right: 30px;\n  float: left;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-left-pic img {\n  border-radius: 50%;\n}\n@media screen and (max-width: 600px) {\n  .spm_wrapper .spm_tools_widget.hc_profile .container-left-pic {\n    width: 100%;\n  }\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-left-pic input {\n  visibility: hidden;\n  opacity: 0;\n  width: 0;\n  height: 0;\n  position: absolute;\n  left: 0;\n  top: 0;\n  pointer-events: none;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-left-pic-block {\n  text-align: left;\n  padding-left: 24%;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-left-pic-block .button_link {\n  display: block;\n  margin-top: 10px;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-left-profile {\n  text-align: left;\n  float: left;\n  width: 70%;\n  position: relative;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-left-profile-name {\n  cursor: pointer;\n  font-size: 32px;\n  font-weight: bold;\n  padding-bottom: 20px;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-left-profile_field {\n  padding-bottom: 10px;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-left-profile_field-name {\n  width: 25%;\n  font-size: 16px;\n  float: left;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-left-profile_field-value {\n  float: left;\n  width: 75%;\n  position: relative;\n  color: rgba(0, 0, 0, 0.5);\n  height: 20px;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-left-profile_field-value-edit {\n  width: 16px;\n  height: 16px;\n  text-decoration: none;\n  cursor: pointer;\n  display: inline-block;\n  vertical-align: middle;\n  z-index: 1;\n  margin-left: 5px;\n  background: url('https://sailplays3.cdnvideo.ru/media/assets/assetfile/c3231ca2ec7e09effef5ce8497b39c32.png') no-repeat center top / auto 90%;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-left-profile_field-value span {\n  vertical-align: middle;\n  display: inline-block;\n  line-height: 20px;\n  font-size: 16px;\n  height: 20px;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-left-profile_field-value input,\n.spm_wrapper .spm_tools_widget.hc_profile .container-left-profile_field-value select {\n  display: none;\n  position: absolute;\n  left: 0;\n  top: 0;\n  font-size: 16px;\n  outline: none;\n  width: 0%;\n  height: 100%;\n  line-height: 20px;\n  box-sizing: border-box;\n  border-top: none;\n  border-left: none;\n  border-right: none;\n  border-bottom: 2px solid #D6D9E3;\n  transition: width .5s ease;\n  background: transparent;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-left-profile_field.type-editing span,\n.spm_wrapper .spm_tools_widget.hc_profile .container-left-profile_field.type-editing a {\n  display: none;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-left-profile_field.type-editing input,\n.spm_wrapper .spm_tools_widget.hc_profile .container-left-profile_field.type-editing select {\n  display: block;\n  width: 100%;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-left-profile-subscribe {\n  display: inline-block;\n  vertical-align: middle;\n  cursor: pointer;\n  box-sizing: border-box;\n  position: relative;\n  padding-left: 20px;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-left-profile-subscribe:first-child {\n  margin-right: 10px;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-left-profile-subscribe:before {\n  content: '';\n  width: 15px;\n  height: 15px;\n  background: rgba(0, 0, 0, 0.15);\n  display: inline-block;\n  position: absolute;\n  top: 0;\n  bottom: 0;\n  left: 0;\n  margin: auto;\n  vertical-align: middle;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-left-profile-subscribe.type-checked:before {\n  background: url(https://sailplays3.cdnvideo.ru/media/assets/assetfile/a514d838259ef72146ef8ba4aaeb2014.png) rgba(0, 0, 0, 0.15) no-repeat center center / 70% auto;\n}\n@media screen and (max-width: 600px) {\n  .spm_wrapper .spm_tools_widget.hc_profile .container-left-profile {\n    width: 100%;\n  }\n}\n@media screen and (max-width: 1100px) {\n  .spm_wrapper .spm_tools_widget.hc_profile .container-left {\n    max-width: 100%;\n    border-top-left-radius: 0;\n  }\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-right {\n  width: 100%;\n  float: left;\n  box-sizing: border-box;\n  padding: 30px;\n  max-width: 300px;\n  background: #D6D9E3;\n  border-top-right-radius: 15px;\n  text-align: center;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-right-balance {\n  font-size: 72px;\n  display: inline-block;\n  width: 100%;\n  padding-top: 10px;\n  font-weight: bold;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-right-placeholder {\n  font-size: 26px;\n  display: inline-block;\n  width: 100%;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-right-discount {\n  font-weight: bold;\n  margin-top: 10px;\n  padding-top: 10px;\n  border-top: 2px solid black;\n  font-size: 26px;\n  display: inline-block;\n  width: 100%;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-right-history {\n  margin: 20px auto 8px;\n}\n@media screen and (max-width: 1100px) {\n  .spm_wrapper .spm_tools_widget.hc_profile .container-right {\n    max-width: 100%;\n    border-top-right-radius: 0;\n  }\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container .bns_overlay_password {\n  text-align: center;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container .bns_overlay_password .bns_overlay_iner {\n  width: 100%;\n  max-width: 300px;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container .bns_overlay_password button {\n  height: 40px !important;\n  width: 100% !important;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container .bns_overlay_password input {\n  width: 100%;\n  height: 40px;\n  line-height: 40px;\n  font-size: 16px;\n  padding: 0 10px;\n  margin-bottom: 10px;\n  box-sizing: border-box;\n  overflow: hidden;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-bottom {\n  float: left;\n  width: 100%;\n  padding-bottom: 100px;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-bottom-line {\n  background: #BDC2D1;\n  height: 30px;\n  position: relative;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-bottom-line_progress {\n  background: white;\n  position: absolute;\n  left: 0;\n  top: -10%;\n  height: 120%;\n  border-top-right-radius: 20px;\n  border-bottom-right-radius: 20px;\n  z-index: 2;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-bottom-line_item {\n  border-radius: 40px;\n  z-index: 2;\n  text-align: center;\n  width: 100px;\n  height: 80px;\n  background: #BDC2D1;\n  position: absolute;\n  top: 50%;\n  box-shadow: 0px 0px 10px 1px rgba(0, 0, 0, 0.4);\n  transform: translate3d(-100%, -50%, 0);\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-bottom-line_item_value {\n  height: 80px;\n  line-height: 80px;\n  font-weight: bold;\n  font-size: 32px;\n  color: white;\n  text-align: center;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-bottom-line_item_get {\n  width: 140px;\n  left: 50%;\n  margin-left: -100px;\n  margin-top: 20px;\n  position: relative;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-bottom-line_item_left {\n  margin-top: 20px;\n  width: 100%;\n  font-size: 18px;\n  font-weight: bold;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-bottom-line_item_received {\n  color: rgba(128, 128, 128, 0.5);\n  margin-top: 20px;\n  width: 100%;\n  font-size: 18px;\n  font-weight: bold;\n  text-transform: lowercase;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-bottom-line_item.type-received {\n  box-shadow: none;\n}\n.spm_wrapper .spm_tools_widget.hc_profile .container-login {\n  text-align: center;\n}\n", ""]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _imageStatuses = __webpack_require__(193);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _leaderboard = __webpack_require__(197);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _pointsStatus = __webpack_require__(201);

	var _pointsStatus2 = _interopRequireDefault(_pointsStatus);

	var _history_pagination = __webpack_require__(202);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _points_rate_progress = __webpack_require__(206);

	var _points_rate_progress2 = _interopRequireDefault(_points_rate_progress);

	var _history_pagination = __webpack_require__(207);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _history_pagination = __webpack_require__(212);

	var _history_pagination2 = _interopRequireDefault(_history_pagination);

	__webpack_require__(213);

	var _avatar_default = __webpack_require__(217);
